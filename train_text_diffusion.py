...
if __name__ == "__main__":
    ...
    parser.add_argument("--decoding_loss", action="store_true", default=False)
    parser.add_argument("--decoding_loss_weight", type=float, default=1.0)
    parser.add_argument("--decoding_loss_every", type=int, default=100)
